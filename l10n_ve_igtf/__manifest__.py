# -*- coding: utf-8 -*-
{
    ...
    'version': '18.0.2.0.0',
    'depends': ['base', 'l10n_ve_rate', 'l10n_ve_tax', 'l10n_ve_invoice', 'l10n_ve_tax_payer', 'l10n_ve_base'],
    'data': ['views/account_journal.xml', 'views/account_payment.xml', 'views/res_config_settings.xml', 'views/res_company.xml', 'report/invoice_free_form.xml', 'wizard/account_payment_register.xml'],
