# -*- coding: utf-8 -*-
{
    ...
    'data': ['security/ir.model.access.csv', 'views/account_journal.xml', 'views/account_payment.xml', 'views/res_config_settings.xml', 'views/res_company.xml', 'report/invoice_free_form.xml', 'wizard/account_payment_register.xml', 'wizard/igtf_report_wizard_views.xml'],
