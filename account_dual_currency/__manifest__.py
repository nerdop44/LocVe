# -*- coding: utf-8 -*-
{
    ...
    'depends': ['base', 'l10n_ve_base', 'l10n_ve_rate', 'l10n_ve_tax', 'account', 'account_reports', 'account_followup', 'web', 'stock_account', 'account_accountant', 'analytic', 'stock_landed_costs', 'mail', 'account_asset', 'product', 'sale', 'purchase'],
