# -*- coding: utf-8 -*-
{
    ...
    'depends': ['account', 'l10n_ve_location'],
    'demo': ['demo/demo_company.xml'],
    'data': ['security/res_groups.xml', 'security/ir_rule.xml', 'data/ir_sequence.xml', 'views/account_journal_views.xml', 'views/account_move_views.xml', 'views/res_config_settings_views.xml', 'views/res_partner_views.xml', 'views/l10n_ve_menuitems.xml'],
    'version': '18.0.2.0.0',
    'license': 'LGPL-3',
