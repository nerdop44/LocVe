    ...
    def get_view(self, view_id=None, view_type="form", **options):
        ...
        if foreign_currency_id:
            ...
            if view_type == "form":
                    ...
                    # view_id_to_check = self.env.ref("l10n_ve_payment_extension.view_account_move_form_locve_invoice", raise_if_not_found=False)

                    # AHORA (la corrección):
                view_id_to_check = self.env.ref("l10n_ve_payment_extension.account_move_form_locve_payment_extension", raise_if_not_found=False)
            ...
            if invoice.is_invoice(True) and invoice.invoice_line_ids:
                ...
                if invoice.invoice_payment_term_id:
                    ...
                    for term in invoice_payment_terms["line_ids"]:
                        if invoice.needed_terms and isinstance(invoice.needed_terms, dict):
